 ...
 */
public class ReleaseAdapter extends XRecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<ReleaseBean.ResultBean> result;


    public ReleaseAdapter(Context context, List<ReleaseBean.ResultBean> result) {
